import React, { createContext, useContext, createElement, useRef, useEffect, useLayoutEffect, useCallback, useMemo, forwardRef, Fragment, Component, useState, cloneElement, Children, isValidElement } from 'react';
...
import { pipe, cubicBezier, linear, easeIn, easeInOut, easeOut, circIn, circInOut, circOut, backIn, backInOut, backOut, anticipate, bounceIn, bounceInOut, bounceOut, inertia, animate as animate$1, velocityPerSecond, distance, mix, clamp, progress, mixColor, interpolate, wrap } from 'popmotion';
...
function useFeatures(props, visualElement, preloadedFeatures) {
    ...
    for (var i = 0; i < numFeatures; i++) {
        ...
        if (isEnabled(props) && Component) {
            features.push(createElement(Component, __assign({ key: name_1 }, props, { visualElement: visualElement })));
        }
    }
    return features;
}
...
function createMotionComponent(_a) {
    ...
    function MotionComponent(props, externalRef) {
        ...
        return (createElement(Fragment, null,
            createElement(MotionContext.Provider, { value: context }, useRender(Component, props, useMotionRef(visualState, context.visualElement, externalRef), visualState, isStatic)),
            features));
    }
...
function LazyMotion(_a) {
    ...
    return (createElement(LazyContext.Provider, { value: { renderer: loadedRenderer.current, strict: strict } }, children));
}
...
export { AnimatePresence, AnimateSharedLayout, DragControls, FlatTree, FramerTreeLayoutContext, LayoutGroupContext, LazyMotion, MotionConfig, MotionConfigContext, MotionValue, PresenceContext, SharedLayoutContext, VisibilityAction, addScaleCorrection, animate, animateVisualElement, animationControls, batchLayout, createBatcher, createCrossfader, createDomMotionComponent, createMotionComponent, domAnimation, domMax, flushLayout, isValidMotionProp, m, motion, motionValue, resolveMotionValue, snapshotViewportBox, transform, useAnimation, useCycle, useAnimatedState as useDeprecatedAnimatedState, useInvertedScale as useDeprecatedInvertedScale, useDomEvent, useDragControls, useElementScroll, useIsPresent, useMotionTemplate, useMotionValue, usePresence, useReducedMotion, useSpring, useTransform, useVelocity, useViewportScroll, visualElement };
